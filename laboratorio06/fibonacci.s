...
@ -- calcula o numero em r0 da sequencia de fibonacci
@ entrada: r0 - numero da sequencia de fibonacci procurado
@saida: r0 - r0-esimo numero da sequencia fibonacci
        
fibonacci:
        sub r0, r0, #2  @ve se a chamada eh pelo primeiro ou segundo termo da 
        mov r1, #1      @sequencia. Se for, ele ja imprime 1, senao, chama
        mov r2, #1      @a funcao loop_fib para calcular o numero da sequencia
        cmp r0, #0
        ble fim
        
@r1: valor atual na seq
@r2: valor anterior na seq
@r3: registrador auxiliar para copia de valores      

        
loop_fib: 
        mov r3, r1      @copia o valor de r1 para r3
        add r1, r1, r2  @atualiza o valor de r1 para o numero seguinte da seq
        mov r2, r3      @copia o valor que estava antes em r1 para r2
        sub r0, r0, #1  @atualiza o contador da sequencia
        cmp r0, #0      @testa para ver se ja acabou o laco
        bgt loop_fib    @se nao acabou, volta para o comeco do laco
